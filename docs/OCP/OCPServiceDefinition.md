...
| How much does it cost? |  Free in 2021/2022 and 2022/2023 fiscal years.  Cost recovery model may be implemented in 2023/2024 fiscal as part of the Enterprise Services cost review directed by Treasury Board, and will continue to consult with clients in that space on <em>whether</em> there will be cost recovery for Private Cloud, as well as  what it will look like if there is one. |  FFree in 2021/2022 and 2022/2023 fiscal years. Cost recovery model may be implemented in 2023/2024 fiscal as part of the Enterprise Services cost review directed by Treasury Board, and will continue to consult with clients in that space on <em>whether</em> there will be cost recovery for for Private Cloud, as well as what it will look like if there is one. |
