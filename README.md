...
### OpenShift 
  ...
  * [Starting a New Project](docs/OCP/StartingANewProject.md)
  * [OpenShift Books](docs/OCP/openshift-books.md)
  * [Run OpenShift on my Workstation](docs/OCP/run-openshift-on-own-computer.md)
  * [OpenShift Networking](docs/OCP/Networking.md)
  * [OpenShift ImageStreams and ImageStreamTags](docs/OCP/ImageStreams.md)
  ...
  * [Route Annotations](docs/OCP/RouteAnnotations.md) 
...
### OpenShift HowTo's
  ...
  * [User Access Request](docs/OCP/RequestUserAccess.md)
  * [RH SSO Realm Request](docs/OCP/RequestSSORealm.md)
  ...
  * [Add ConfigMap to deployment](docs/HowTo/CreateConfigMagForApp.md)
...
### Databases
  ...
  * [PostgreSQL crash loop caused by a tuple concurrently updated error](docs/DB/PostgresqlCrashLoopTupleError.md)
  * [PostgreSQL Server stuck in recovery loop, server not starting up](docs/DB/PostgresqlStuckInRecovery.md)
  * [PostgreSQL Backup and Restore](docs/DB/PostgreSQLBackupRestore.md)
...
### Jenkins
  ...
  * [Automate GitHub tasks using Jenkins](docs/Jenkins/AutomateTasks.md)

### Jenkins Pipelines

  * [Using Shared Libs](docs/Jenkins/UsingTheSharedLib.md)
...
### SSL Certificates
  ...
  * [How-to: Create a self-signed certificate](docs/SSLCerts/CreateSelfSignedCert.md)
